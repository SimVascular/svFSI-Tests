...
def setDomainID(FileName):
    ...
    for icel in range(0, msh_ncel):
        ...
        for i in range(0, cur_cel_npts):
            ...
            if xp[0] < 1.50001 and \
               xp[1] < 1.50001 and \
               xp[2] < 1.50001: cnt = cnt + 1
        if cnt == cur_cel_npts: domain_id[icel] = 2
...
if __name__ == '__main__':
    setDomainID("01-h0.50/mesh-complete.mesh.vtu")
    setDomainID("02-h0.25/mesh-complete.mesh.vtu")
    setDomainID("03-h0.125/mesh-complete.mesh.vtu")
    setDomainID("04-h0.0625/mesh-complete.mesh.vtu")
    setDomainID("05-h0.125_tet/mesh-complete.mesh.vtu")
